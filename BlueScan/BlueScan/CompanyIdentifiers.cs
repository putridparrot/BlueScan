...
namespace BlueScan
{
    public static class CompanyIdentifiers
    {
        private static readonly Dictionary<int, string> _companies;

        static CompanyIdentifiers()
        {
            _companies = new Dictionary<int, string>
            {
        ...
        public static string GetDisplayName(int companyId)
        {
            return _companies.TryGetValue(companyId, out string name) ? name : null;
        }
    }
}
